create table kiva_parts(
	...
	delinqrate float(5,2),
	defrate float(5,2),
	exchangeloss float(5,2),
	...
	aveloangdp float(5,2),
	averaised float(10,2),
	aveloanterm varchar(128),
	totaljournals int,
	journalcoverage float(5,2),
	journalkivaents float(5,2),
	journalsfreq float(5,2),
	averecommend float(5,2),
	aveinterest float(5,2),
	avelocalinterest float(5,2)
);
...
create table kiva_ent(
	...
	delinquentrate float(5,2),
	defaultrate float(5,2),
